...
function updatePassword(currentPassword, newPassword) {
    return fetch(APPLICATION_URL + '/old/settings/account/security/update-password', {
        method: 'POST',
        headers: {
...
async function showAddTwoFactorAuthenticationModal() {
    const request = await fetch(APPLICATION_URL + '/old/settings/account/security/create-totp-uri', {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json'
        },
...
async function enableTOTP() {
    ...
    await fetch(APPLICATION_URL + '/old/settings/account/security/enable-totp', {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json'
        },
