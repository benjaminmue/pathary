...
async function reloadTable(featureIsEnabled = true) {
    ...
    const response = await fetch(APPLICATION_URL + '/old/settings/locations');
...
async function sendRequestToggleLocationsFeature(isLocationsEnabled) {
    const response = await fetch(APPLICATION_URL + '/old/settings/locations/toggle-feature', {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json'
        },
...
async function sendRequestFetchIsLocationsFeatureEnabled() {
    const response = await fetch(APPLICATION_URL + '/old/settings/locations/toggle-feature', {method: 'GET'})
