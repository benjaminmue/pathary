...
function updateGeneral(dateFormat, username, privacyLevel, enableAutomaticWatchlistRemoval, country, displayCharacterNames, displayTmdbRatings, displayImdbRatings) {
    return fetch(APPLICATION_URL + '/old/settings/account', {
        method: 'POST',
        headers: {
...
async function deleteApiTokenRequest() {
    const response = await fetch(APPLICATION_URL + '/old/settings/account/general/api-token', {'method': 'delete'})
...
async function regenerateApiTokenRequest() {
    const response = await fetch(APPLICATION_URL + '/old/settings/account/general/api-token', {'method': 'put'})
...
fetch(
    APPLICATION_URL + '/old/settings/account/general/api-token'
