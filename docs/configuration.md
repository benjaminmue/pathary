...
| `APPLICATION_NAME`                          |   `Pathary`   | Application name, displayed e.g. as brand name in the navbar            |  yes   |
...
| `TOTP_ISSUER`                               |   `Pathary`   | The issuer used when setting up two factor authentication               |        |
...
| `PLEX_APP_NAME`      |   `Pathary`   | Used for Plex Authentication                                                       |        |
| `JELLYFIN_DEVICE_ID` |       -       | Required for Jellyfin Authentication. Generate with e.g. `openssl rand -base64 32` |        |
| `JELLYFIN_APP_NAME`  |   `Pathary`   | Used for Jellyfin Authentication                                                   |        |
...
| NAME | DEFAULT VALUE | INFO | Web UI |
|:-----|:-------------:|:-----|:------:|
| `ENCRYPTION_KEY` | - | AES-256 key for OAuth secrets (generate: `openssl rand -base64 32`) | no |
