...
$builder->addDefinitions(
    [
        ...
        \Movary\Api\Omdb\OmdbClient::class => DI\factory([Factory::class, 'createOmdbClient']),
        \Movary\Api\Omdb\OmdbApi::class => DI\factory([Factory::class, 'createOmdbApi']),
        \Movary\Service\Omdb\OmdbMovieRatingSync::class => DI\factory([Factory::class, 'createOmdbMovieRatingSync']),
